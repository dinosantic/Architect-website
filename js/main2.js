...
function animation_in(slide){
  ...
  var image = slide.find('.portrait2');
  var icon1 = $(slide).find('.mail');
  var icon2 = $(slide).find('.instagram');
  var icon3 = $(slide).find('.facebook');
  var icon4 = $(slide).find('.twitter');
  ...
  TweenMax.fromTo(image, 0.6,{autoAlpha:0, x:100}, {autoAlpha:0.6, x:0, ease: Power2.easeOut});
  TweenMax.from(icon1, 0.3,{y: -15, autoAlpha:0, ease:Power1.easeOut, delay: 0.2});
  TweenMax.from(icon2, 0.3,{y: -15, autoAlpha:0, ease:Power1.easeOut, delay: 0.4});
  TweenMax.from(icon3, 0.3,{y: -15, autoAlpha:0, ease:Power1.easeOut, delay: 0.6});
  TweenMax.from(icon4, 0.3,{y: -15, autoAlpha:0, ease:Power1.easeOut, delay: 0.8});
}
...
function animation_out(slide){
  ...
  TweenMax.to(icon1, 0.6,{y: -150, repeat: 1, yoyo: true, ease: Power2.easeOut});
  TweenMax.to(icon2, 0.6,{y: -150, repeat: 1, yoyo: true, ease: Power2.easeOut});
  TweenMax.to(icon3, 0.6,{y: -150, repeat: 1, yoyo: true, ease: Power2.easeOut});
  TweenMax.to(icon4, 0.6,{y: -150, repeat: 1, yoyo: true, ease: Power2.easeOut});
}
